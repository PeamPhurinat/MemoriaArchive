...
const modeToggleButton = app.querySelector(".mode-toggle");
const customPanel = app.querySelector(".custom-panel");
const customStatus = app.querySelector(".custom-status");
const userIdInput = app.querySelector(".custom-user-input");
const moveButton = app.querySelector(".tool-move");
const resizeButton = app.querySelector(".tool-resize");
const deleteButton = app.querySelector(".tool-delete");
const scaleSlider = app.querySelector(".custom-scale");
const scaleValue = app.querySelector(".custom-scale-value");
const saveButton = app.querySelector(".tool-save");
const loadButton = app.querySelector(".tool-load");
const resetButton = app.querySelector(".tool-reset");
const reticle = app.querySelector(".reticle");
